...
parser.add_argument(
    ...
    #required=True,
    default= 'C:/Users/kushk/Desktop/University/2nd Year/Data Science/Cw/l2-ip-assignment/l2-ip-assignment/code/project.avi')
parser.add_argument(
    "-cl",
    "--class_file",
    type=str,
    help="list of classes",
    default='C:/Users/kushk/Desktop/University/2nd Year/Data Science/Cw/l2-ip-assignment/l2-ip-assignment/code/coco.names')
parser.add_argument(
    "-cf",
    "--config_file",
    type=str,
    help="network config",
    default='C:/Users/kushk/Desktop/University/2nd Year/Data Science/Cw/l2-ip-assignment/l2-ip-assignment/code/yolov3.cfg')
parser.add_argument(
    "-w",
    "--weights_file",
    type=str,
    help="network weights",
    default='C:/Users/kushk/Desktop/University/2nd Year/Data Science/Cw/l2-ip-assignment/l2-ip-assignment/code/yolov3.weights')
...
output_video_file_name = 'output_video_validation2.avi'
...
if (((args.video_file) and (cap.open(str(args.video_file))))):
    ...
    out_video = cv2.VideoWriter(output_video_file_name, cv2.VideoWriter_fourcc('m', 'p', '4', 'v') , 3, size)

    for i in range(len(frames)):
        out_video.write(frames[i])
    out_video.release()

    # conf_text = '%s: %.2f' % ("Mean_Conf", conf_average)
    # count_text = '%s: %d' % ("Obj_Count", conf_count)
    # score_eq = '%s' % ("Score = Mean(Mean_Conf, Obj_Count/Total_Count)")
    score_text = f"Score = ({conf_average:.2f} + {conf_count}/{total_count})/2 = {(conf_average + conf_count/total_count)/2:.3f}"
    score = (conf_average + conf_count/total_count)/2
    print(score_text)
