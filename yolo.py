...
parser.add_argument(
    ...
    # required=True
    default="C:/Users/kushk/Desktop/University/2nd Year/Data Science/Cw/l2-ip-assignment/l2-ip-assignment/test-corrupt.avi")
parser.add_argument(
    "-cl",
    "--class_file",
    type=str,
...
output_video_file_name = 'output_video_validation.avi'
